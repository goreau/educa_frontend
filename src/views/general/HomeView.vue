  ...
  <div class="home">
   ...
   <!-- <div class="columns">
      <div class="column is-full has-text-centered pt-6 mt-6">
        ...
        <br>
        <p class="title">Sistema de Controle de Inseticidas</p>
        <p class="place">Coordenadoria de Controle de Doenças</p>
      </div>
    </div>-->
    <div class="columns">
      <div class="column is-full has-text-centered pt-6 mt-6">
    <div class="box">
            ...
            <p class="title place" style="margin-top: 5%;">Sistema para registro de informações sobre atividades educativas
</p>
    </div>
    </div></div>
  </div>
