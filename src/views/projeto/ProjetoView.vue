                            ...
                            <div class="columns">
                                <div class="column is-half">
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <CmbPrograma @selProg="projetos.id_programas = $event" />
...
export default {
    ...
    methods: {
        details(){
            this.$router.push(`/cronograma/${this.id_projetos}`);
        },
        create() {
            ...
            if (!this.v$.$error) {
                ...
                projetosService.create(this.projetos).then(
                    (response) => {
                        this.showMessage = true;
                        this.message = "Projeto inserido com sucesso!!";
                        this.type = "success";
                        this.caption = "Projeto";
                        setTimeout(() => {
                            this.showMessage = false; 
                            this.id_projetos = response.data.master.id_projetos;
