                            ...
                            <div class="columns">
                                ...
                                <div class="column is-half">
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <CmbPrograma @selProg="educacao.id_programas = $event" />
                            ...
                            <div class="columns">
                                ...
                                <div class="column is-half">
                                    <div class="field">
                                        ...
                                        <input type="number" class="input" placeholder="Numérico" min="0" v-model="educacao.dias" />
...
export default {
    ...
    methods: {
        details(){
            this.$router.push(`/educacao_det/${this.id_educacao}/${this.educacao.id_atividade}`);
        },
        startCalendar(){
            const options = {
                type: "date",
        ...
        create() {
            ...
            if (!this.v$.$error) {
                ...
                educacaoService.create(this.educacao).then(
                    (response) => {
                        this.showMessage = true;
                        this.message = "Atividade inserida com sucesso!!";
                        this.type = "success";
                        this.caption = "Atividade";
                        setTimeout(() => {
                            this.showMessage = false;
                            this.id_educacao = response.data.master.id_educacao;
